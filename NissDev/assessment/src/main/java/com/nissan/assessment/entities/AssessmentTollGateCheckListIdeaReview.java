...
@Table
@Entity
public class AssessmentTollGateCheckListIdeaReview {
	...
	private AssessmentTollGateChecklist tollGateCheckList;
	...
	public AssessmentTollGateChecklist getTollGateCheckList() {
		return tollGateCheckList;
	}

	public void setTollGateCheckList(AssessmentTollGateChecklist tollGateCheckList) {
