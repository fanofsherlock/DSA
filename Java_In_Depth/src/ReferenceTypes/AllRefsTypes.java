...
public class AllRefsTypes {
	...
	public static void main(String[] args) {
		...
		// -XX:G1NewSizePercent=50 -XX:+UseG1GC
		// or with
		...
		System.out.println(
				"Final used mem " + getUsedMem() + "    Refs removed " + removed + "   left " + references.size());

	}

	private static void allocationLoop(ReferenceQueue<HeavyList> queue, Set<Reference<HeavyList>> references,
			int howManyTimes) {
...
//                Reference<HeavyList> reference = new PhantomReference<>(curr, queue);
			...
			System.out.println(
					"used mem " + getUsedMem() + "    Refs removed " + removed + "   left " + references.size());
